...
stn06 <- read.csv(here::here("metabolizer_dataframe/stn06_df_feb18.csv"))
stn06$solar.time <- as.POSIXct(stn06$solar.time,format="%Y-%m-%d %H:%M:%S",tz="UTC")

#let's see about just 2019 data
dat <- stn06%>%
  filter(solar.time > as.POSIXct("2023-01-01 00:00:00"))
...
#write.csv(data_inspection,here::here("StreamMetabolizer/Predictions/data_inspection_stn06_feb11_all.csv"))
