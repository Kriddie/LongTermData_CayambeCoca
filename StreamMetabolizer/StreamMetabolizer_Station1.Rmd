...
bayes_specs$K600_lnQ_nodes_meanlog <- rep(prior_K600_lnQ_nodes_meanlog(slope=0.01, depth=0.1846732),length(bayes_specs$K600_lnQ_nodes_centers))
...
Feb 12, stn01 all data, k600 partially pooled start=5:30 end = before 

Feb12, stn01 2019 data, k600 partially pooled start: 8:42
...
#write.csv(data_inspection,here::here("StreamMetabolizer/Predictions/data_inspection_stn01_feb12_2019.csv"))

#write.csv(predictions,here::here("StreamMetabolizer/Predictions/MetabPredictions_stn01_2019_feb12df.csv"))

#save model
#save(mm, file = "model_stn01_partially-pooled_feb12_2019.RData")
