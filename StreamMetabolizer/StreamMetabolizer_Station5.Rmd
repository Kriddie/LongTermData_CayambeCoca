...
stn05 <- read.csv(here::here("metabolizer_dataframe/stn05_df_feb19.csv"))
...
bayes_specs <- specs(bayes_name, burnin_steps=500, saved_steps=1000, n_cores=1)
...
#save model
#save(mm, file = "model_stn06_partially-pooled_stn06_feb18_June2021.RData")
