...
stn02 <- read.csv(here::here("metabolizer_dataframe/stn02_df_fieldLUX_march9.csv"))
...
#write.csv(predictions,here::here("StreamMetabolizer/Predictions/MetabPredictions_stn02_fieldLUX_march09df.csv"))
...
#write.csv(daily_fit,here::here("StreamMetabolizer/Predictions_bestones/station2_fieldlight_march9.csv"))
```
