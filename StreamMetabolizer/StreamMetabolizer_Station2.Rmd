...
dat <- stn02%>%#drop_na(DO.obs)%>%
#  filter(solar.time < as.POSIXct("2019-08-13 00:00:00"))%>%
  filter(solar.time > as.POSIXct("2021-06-01 00:00:00") &
           solar.time < as.POSIXct("2022-06-01 00:00:00"))
...
#save model
#save(mm, file = "model_stn02_partially-pooled_stn02_feb08.RData")
...
ggplot(data_inspection,aes(x=ER.daily,y=K600.daily)) + geom_point()
