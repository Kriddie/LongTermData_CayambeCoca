...
stn04 <- read.csv(here::here("metabolizer_dataframe/stn04_df_CalcLight_march10.csv"))
stn04$solar.time <- as.POSIXct(stn04$solar.time,format="%Y-%m-%d %H:%M:%S",tz="UTC")
...
Feb 11, stn04 all data, k600 partialy poiled start=12:00 end = 1:25
...
#save model
save(mm, file = "model_stn04_partially-pooled_stn04_feb11_all.RData")
...
#write.csv(data_inspection,here::here("StreamMetabolizer/Predictions/data_inspection_stn04_feb11_all.csv"))
