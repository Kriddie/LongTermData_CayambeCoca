...
plot_ly(WL_03, x = ~DateTime, y = ~WLPres_kpa, type = 'scatter', mode = 'markers') 
...
dup <- Baro$DateTime[duplicated(Baro$DateTime)]
dup2 <- WL_03$DateTime[duplicated(WL_03$DateTime)]
...
ggplot(data = WL_03 %>% filter(DateTime > "2021-06-10"), 
       aes(DateTime, WL_m)) +
  geom_point(color = "steelblue") +
  labs(title = "Station 03 Water level",
    y = "water level [m]", x = "") 
...
#write.csv(WL_03,here::here("MergedFiles/WL_03_2023-12-19.csv"))
...
ggplot(data = WL_03 %>% filter(DateTime > "2021-06-10"), 
       aes(DateTime, Q_m3s)) +
  geom_point(color = "steelblue") +
  labs(title = "Station 03 Discharge",
    y = "Q [m3 s-1]", x = "") 
