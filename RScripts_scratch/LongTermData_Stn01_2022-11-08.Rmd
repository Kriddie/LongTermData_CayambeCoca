...
### stn 03
WLData <- read.csv(here::here("WL/WL_stn3_2019_2019-08-14edit.csv"), skip=11, header = TRUE, sep = ",",quote = "\"",dec = ".", fill = TRUE, comment.char = "")
...
lines(q,y_mdl3,col='yellow',lwd=1)
#lines(q,y_mdl4,col='green',lwd=1)
mtext("y= -30631.71   + 1468.771  *x -23.42528  *x^2 + 0.1245258*x^3", side=3)
...
WL_01_fill <- WL_03
WL_01_fill$WLPres_kpa <-   -30631.71 + 1468.771 *WL_01_fill$WLPres_kpa - 23.42528 *(WL_01_fill$WLPres_kpa)^2 + 0.1245258 * (WL_01_fill$WLPres_kpa)^3
...
site_names=c("CO2_01","CO2_01wellV")
...
#plot_ly(CO2_01%>%filter(DateTime > as.POSIXct("2021-06-01 00:00:00", tz = "UTC")), x = ~DateTime, y = ~ppm, type = 'scatter', mode = 'markers') 
...
#and then I added a difernt viasala

Stn01$adjusted_ppm <- Stn01$ppm * (1 + (1013 - Stn01$Total_hPa) * 0.0015) * (1 - (25 - Stn01$WLTemp_c) * 0.003)
