...
#remove duplicates
WL_02_select1 <- WL_02%>%filter(DateTime>=as.POSIXct("2022-06-30 12:45:00",tz="UTC")&DateTime <= as.POSIXct("2022-06-30 13:15:00",tz="UTC"))%>%filter(WLTemp_c<11)
WL_02 <- WL_02%>%filter(DateTime<as.POSIXct("2022-06-30 12:45:00",tz="UTC")|DateTime > as.POSIXct("2022-06-30 13:15:00",tz="UTC"))%>%filter(WLTemp_c<11)
WL_02 <- rbind(WL_02,WL_02_select1)
