...
WL_m <- Stn02_df%>%filter(DateTime == as.POSIXct(paste(date, time), format="%Y-%m-%d %H:%M:%S", tz = "UTC"))
...
#but then I changed it to an old vaisala at the beggining of 2022, unfortunately, it collected very little data before totally crapping out on me (my fault, in truth)
