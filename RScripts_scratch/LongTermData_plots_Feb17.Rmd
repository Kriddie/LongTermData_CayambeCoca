...
all_stn_remove <- all_stn%>%filter(DateTime!=as.POSIXct("2021-07-05 11:15:00",tz="UTC"))%>%
...
p4 <- ggplot() + 
  geom_point(data=all_stn_remove%>%filter(DateTime>"2021-06-06 00:00:00"),aes(x=CO2_ppm_01,y=CO2_ppm_04,color=month)) +
    scale_y_continuous(transform = "log", breaks = c(300,1000,3000,10000,30000))+
  scale_x_continuous(transform = "log", breaks = c(300,1000,3000,10000,30000))+
